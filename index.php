	...
	<div class="col-md-7 well">
		...
		while ($fetch = $query->fetch_array()) {
			...
			<div class="pull-left" style="height:350px; width:220px; margin:8px; border:1px solid #000; padding:5px; border-radius:5px;">
				...
				<center>
					<h4><strong><?php echo $fetch['product_name'] ?></strong></h4>
				</center>
				<center>
					<h4 class="text-danger">&#8369; <?php echo number_format($fetch['product_price']) ?></h4>
				</center>
				...
				if (!empty($_SESSION["cart"])) {
					...
					foreach ($_SESSION["cart"] as $keys => $values) {
						...
						<tr>
							...
							<td>
								<center><a class="btn btn-danger" href="delete.php?id=<?php echo $values['product_id'] ?>"><span class="glyphicon glyphicon-remove"></span></a></center>
							</td>
						</tr>
					<?php
